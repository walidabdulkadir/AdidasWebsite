...
function Description() {
  return (
    <section className="relative w-full bg-gradient-to-r from-[#bb5d01] to-[#ff9d2e] overflow-hidden min-h-[440px] sm:min-h-[520px] md:min-h-[580px]">
      ...
      {/* ── All text ── */}
      <div className="relative flex flex-col items-center px-6 md:px-12 py-10 gap-8 min-h-[520px]">

        {/* Heading */}
        <h1 className="relative z-0 uppercase text-white font-extrabold text-center leading-none tracking-tight w-full
        ...
        <div className="relative z-30 grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8 w-full mt-2">
          ...
          {/* LEFT — paragraph 1 */}
          <p className="text-white text-xs sm:text-sm md:text-base leading-relaxed max-w-[300px]">
          ...
          {/* RIGHT — paragraph 1 */}
          <p className="text-white text-xs sm:text-sm md:text-base leading-relaxed md:text-right md:ml-auto max-w-[300px]">
        ...
        <p className="relative z-30 text-white font-bold text-center text-sm sm:text-base mt-4 pb-4">
          To improve performances. Improve lives<br />and change the world.
        </p>
